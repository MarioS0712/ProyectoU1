...
public class Ventana extends JFrame {
    ...
    private void initOeste() {
        ...
        for (int i = 0; i < tiposMascota.length; i++) {
            rbMascotas[i] = new RBoton(tiposMascota[i] + " $5", "no.png", "sii.png");
        ...
        for (int i = 0; i < servicios.length; i++) {
            cbServicios[i] = new CheckBoxP(servicios[i] + " $5", "Huellita1.png", "Huellita2.png");
        ...
        for (int i = 0; i < extras.length; i++) {
            cbExtras[i] = new CheckBoxP(extras[i] + " $10", "Huellita1.png", "Huellita2.png");
    ...
    private void initSur() {
        ...
        JButton btnAñadir = new Boton1("Añadir Mascota", "/proyectou1/agregar.png");
        JButton btnAtender = new Boton1("Atender Mascota", "/proyectou1/atender.png");
        JButton btnFinSer = new Boton1("Finalizar servicio", "/proyectou1/fin.png");
        JButton btnSalir = new Boton1("Salir", "/proyectou1/salir.png");
        JButton btnInfo = new Boton1("Info", "/proyectou1/info.png");
